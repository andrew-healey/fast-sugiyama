...
// import { findVertexById } from '@/utils/graph';
...
//     const downVertex = findVertexById(pg, vec[1].id);
//     if (!(upVertex && downVertex)) return vec;
//     if (penlty > 0) {
//       pg.addEdge(
//         new Edge(upVertex, downVertex, {
//           penalty: penlty,
//         }),
//       );
//     } else if (penlty < 0) {
//       pg.addEdge(
//         new Edge(downVertex, upVertex, {
//           penalty: 0 - penlty,
//         }),
//       );
//     }
